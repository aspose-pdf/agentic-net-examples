...
class Program
{
    static void Main()
    {
        ...
        // 1. Encrypt the PDF with both user and owner passwords.
        ...
        // 2. Remove the user password while keeping the document encrypted.
        ...
        {
            // Change passwords: keep the same owner password, set a new (empty) user password.
            encDoc.ChangePasswords(ownerPassword, "", ownerPassword);

            // Save the final PDF (still encrypted, but without a user password).
