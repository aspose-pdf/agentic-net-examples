...
- `using Aspose.Pdf;` (75/75 files) ← category-specific
- `using Aspose.Pdf.Drawing;` (71/75 files) ← category-specific
- `using Aspose.Pdf.Text;` (7/75 files)
- `using Aspose.Pdf.Annotations;` (2/75 files)
- `using Aspose.Pdf.Operators;` (2/75 files)
- `using System;` (75/75 files)
- `using System.Runtime.InteropServices;` (41/75 files) ← category-specific
- `using System.IO;` (28/75 files)
- `using System.Collections.Generic;` (6/75 files)
- `using System.Diagnostics.CodeAnalysis;` (1/75 files)
- `using System.Drawing;` (1/75 files)
