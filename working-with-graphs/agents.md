...
- `using Aspose.Pdf.Drawing;` (80/84 files) ← category-specific
- `using Aspose.Pdf.Text;` (10/84 files)
- `using Aspose.Pdf.Facades;` (4/84 files)
- `using Aspose.Pdf.Operators;` (3/84 files)
- `using Aspose.Pdf.Annotations;` (2/84 files)
- `using Aspose.Pdf.Generator;` (1/84 files)
- `using System;` (84/84 files)
- `using System.IO;` (34/84 files)
- `using System.Collections.Generic;` (5/84 files)
- `using NUnit.Framework;` (1/84 files)
...
| [apply-a-texture-brush-as-fill-for-an-ellipse-by-lo...](./apply-a-texture-brush-as-fill-for-an-ellipse-by-loading-an-image-resource-as-a-pattern.cs) | Apply A Texture Brush As Fill For An Ellipse By Loading An I... | `MarginInfo` | Apply A Texture Brush As Fill For An Ellipse By Loading An Image Resource As A Pattern |
