...
<script type="application/ld+json">
{
  ...
  "name": "Stamping -- Aspose.PDF for .NET Examples",
  "description": "50 verified, compile-tested C# examples demonstrating stamping operations in Aspose.PDF for .NET 26.7.0.",
  ...
  "codeRepository": "https://github.com/aspose-pdf/agentic-net-examples.git/tree/main/stamping",
...
- [`add-custom-sized-page-stamp.cs`](./add-custom-sized-page-stamp.cs) -- Add custom sized page stamp
- [`add-custom-text-stamp-to-pdf.cs`](./add-custom-text-stamp-to-pdf.cs) -- Add custom text stamp to pdf
...
- [`add-faint-text-overlay-stamp-to-pdf-pages.cs`](./add-faint-text-overlay-stamp-to-pdf-pages.cs) -- Add faint text overlay stamp to pdf pages
- [`add-fixed-size-image-stamp-to-pdf-pages.cs`](./add-fixed-size-image-stamp-to-pdf-pages.cs) -- Add fixed size image stamp to pdf pages
- [`add-full-page-image-watermark.cs`](./add-full-page-image-watermark.cs) -- Add full page image watermark
- [`add-fully-opaque-image-watermark.cs`](./add-fully-opaque-image-watermark.cs) -- Add fully opaque image watermark
...
- [`add-image-stamp-alt-text-pdfa1b.cs`](./add-image-stamp-alt-text-pdfa1b.cs) -- Add image stamp alt text pdfa1b
- [`add-image-stamp-as-background-to-pdf-pages.cs`](./add-image-stamp-as-background-to-pdf-pages.cs) -- Add image stamp as background to pdf pages
- [`add-image-stamp-flatten-annotations.cs`](./add-image-stamp-flatten-annotations.cs) -- Add image stamp flatten annotations
- [`add-image-stamp-from-memory-stream.cs`](./add-image-stamp-from-memory-stream.cs) -- Add image stamp from memory stream
- [`add-image-stamp-preserve-acroform-fields.cs`](./add-image-stamp-preserve-acroform-fields.cs) -- Add image stamp preserve acroform fields
...
- [`add-image-stamp-to-page-two.cs`](./add-image-stamp-to-page-two.cs) -- Add image stamp to page two
- [`add-image-stamp-to-pdf-with-form-fields.cs`](./add-image-stamp-to-pdf-with-form-fields.cs) -- Add image stamp to pdf with form fields
...
- [`add-image-stamp-with-alt-text-to-pdf-page.cs`](./add-image-stamp-with-alt-text-to-pdf-page.cs) -- Add image stamp with alt text to pdf page
...
- [`add-slanted-text-watermark-to-pdf.cs`](./add-slanted-text-watermark-to-pdf.cs) -- Add slanted text watermark to pdf
- [`add-text-stamp-auto-adjust-font-size.cs`](./add-text-stamp-auto-adjust-font-size.cs) -- Add text stamp auto adjust font size
...
- [`align-text-stamp-bottom-left-margin.cs`](./align-text-stamp-bottom-left-margin.cs) -- Align text stamp bottom left margin
- [`apply-image-stamp-percentage-offsets.cs`](./apply-image-stamp-percentage-offsets.cs) -- Apply image stamp percentage offsets
...
- [`create-page-stamp-from-pdf.cs`](./create-page-stamp-from-pdf.cs) -- Create page stamp from pdf
- [`fit-image-stamp-rectangle.cs`](./fit-image-stamp-rectangle.cs) -- Fit image stamp rectangle
- [`place-image-stamp-at-custom-coordinates.cs`](./place-image-stamp-at-custom-coordinates.cs) -- Place image stamp at custom coordinates
- [`rotate-image-stamp-45-degrees.cs`](./rotate-image-stamp-45-degrees.cs) -- Rotate image stamp 45 degrees
