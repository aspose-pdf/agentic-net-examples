---
name: working_with_annotations
description: C# examples for working_with_annotations using Aspose.PDF for .NET
language: csharp
framework: net10.0
parent: ../agents.md
---

# AGENTS - working_with_annotations

## Persona

You are a C# developer specializing in PDF processing using Aspose.PDF for .NET,
working within the **working_with_annotations** category.
This folder contains standalone C# examples for working_with_annotations operations.
See the root [agents.md](../agents.md) for repository-wide conventions and boundaries.

## Scope
- This folder contains examples for **working_with_annotations**.
- Files are standalone `.cs` examples stored directly in this folder.

## Required Namespaces

- `using Aspose.Pdf;` (153/153 files) ← category-specific
- `using Aspose.Pdf.Annotations;` (123/153 files) ← category-specific
- `using Aspose.Pdf.Text;` (15/153 files)
- `using Aspose.Pdf.Facades;` (10/153 files)
- `using Aspose.Pdf.Forms;` (9/153 files)
- `using Aspose.Pdf.Drawing;` (7/153 files)
- `using Aspose.Pdf.Devices;` (1/153 files)
- `using Aspose.Pdf.LogicalStructure;` (1/153 files)
- `using System;` (153/153 files)
- `using System.IO;` (146/153 files)
- `using System.Collections.Generic;` (15/153 files)
- `using System.Drawing;` (5/153 files)
- `using System.Text;` (2/153 files)
- `using Azure.Storage.Blobs;` (1/153 files)
- `using System.Linq;` (1/153 files)
- `using System.Net.Http;` (1/153 files)
- `using System.Net.Http.Headers;` (1/153 files)
- `using System.Text.Json;` (1/153 files)
- `using System.Threading.Tasks;` (1/153 files)
- `using System.Xml.Linq;` (1/153 files)
...
| [add-polyline-figure-annotation](./add-polyline-figure-annotation.cs) | Add Polyline Figure Annotation to PDF | `Document`, `Page`, `PolylineAnnotation` | Demonstrates how to create a polyline figure annotation by defining vertices, computing a boundin... |
| ... | | | *and 123 more files* |
...
- Review code examples in this folder for working_with_annotations patterns

<!-- AUTOGENERATED:START -->
Updated: 2026-04-07 | Run: `20260407_155215_3cf1af`
<!-- AUTOGENERATED:END -->
