...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine($"Attachments deleted and saved to '{outputPath}'.");
        ...
        {
            Console.WriteLine("Verification succeeded: no attachments remain.");
        }
        else
        {
            Console.WriteLine("Verification failed: some attachments are still present.");
        }
    }
}