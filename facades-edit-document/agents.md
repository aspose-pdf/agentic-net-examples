...
- `using Aspose.Pdf.Facades;` (182/207 files) ← category-specific
- `using Aspose.Pdf;` (119/207 files) ← category-specific
- `using Aspose.Pdf.Annotations;` (26/207 files)
- `using Aspose.Pdf.Text;` (18/207 files)
- `using Aspose.Pdf.Devices;` (9/207 files)
- `using Aspose.Pdf.Printing;` (4/207 files)
- `using Aspose.Pdf.Security;` (2/207 files)
- `using Aspose.Pdf.Drawing;` (1/207 files)
- `using System;` (207/207 files)
- `using System.IO;` (195/207 files)
- `using System.Drawing;` (30/207 files)
- `using System.Collections.Generic;` (15/207 files)
- `using System.Text.Json;` (6/207 files)
- `using System.Drawing.Imaging;` (5/207 files)
- `using System.Threading.Tasks;` (4/207 files)
- `using System.Drawing.Printing;` (3/207 files)
- `using System.Net.Http;` (3/207 files)
- `using System.Runtime.InteropServices;` (3/207 files)
- `using System.Xml;` (2/207 files)
- `using System.Xml.Linq;` (2/207 files)
- `using Microsoft.VisualStudio.TestTools.UnitTesting;` (1/207 files)
- `using System.Collections;` (1/207 files)
- `using System.Runtime.Versioning;` (1/207 files)
- `using System.Security.Cryptography;` (1/207 files)
- `using System.Threading;` (1/207 files)
...
| [add-file-attachment-link-annotation](./add-file-attachment-link-annotation.cs) | Add File Attachment Link Annotation to PDF | `PdfContentEditor`, `BindPdf`, `CreateFileAttachment` | Demonstrates how to add a clickable file‑attachment annotation that opens an attached PDF when th... |
| ... | | | *and 177 more files* |
...
<!-- AUTOGENERATED:START -->
Updated: 2026-05-05 | Run: `20260505_103914_33e9e8`
<!-- AUTOGENERATED:END -->
