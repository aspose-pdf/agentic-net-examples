...
- `using Aspose.Pdf.Validation;` (1/45 files)
...
| [apply-custom-row-borders-to-pdf-table](./apply-custom-row-borders-to-pdf-table.cs) | Apply Custom Row Borders to PDF Table Cells | `Document`, `Page`, `Table` | Shows how to set different border thickness, color, and background for table rows based on their ... |
...
| [batch-convert-pdfs-to-tagged-pdfs](./batch-convert-pdfs-to-tagged-pdfs.cs) | Batch Convert PDFs to Tagged PDFs with Auto‑Tagging | `Document`, `Convert`, `Save` | Demonstrates how to process a folder of untagged PDFs, enable Aspose.Pdf auto‑tagging, set langua... |
...
| [create-a-nested-list-with-bullet-and-numbered-item...](./create-a-nested-list-with-bullet-and-numbered-items-assign-appropriate-list-tags-and-validate.cs) | Create A Nested List With Bullet And Numbered Items Assign A... |  | Create A Nested List With Bullet And Numbered Items Assign Appropriate List Tags And Validate |
...
| [create-styled-table-pdf](./create-styled-table-pdf.cs) | Create Styled Table in PDF | `Document`, `Page`, `Table` | Demonstrates how to build a PDF with a three‑column table where each cell has custom background c... |
...
<!-- AUTOGENERATED:START -->
Updated: 2026-04-09 | Run: `20260409_101447_0afd8e`
<!-- AUTOGENERATED:END -->
