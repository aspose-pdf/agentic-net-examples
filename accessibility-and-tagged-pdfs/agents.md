...
- `using System.Runtime.InteropServices;` (1/45 files)
...
| [create-tagged-pdf-table-validate-pdfua](./create-tagged-pdf-table-validate-pdfua.cs) | Create Tagged PDF Table with Data Type Tags and Validate PDF... | `Document`, `ITaggedContent`, `StructureElement` | Demonstrates how to add a table to a PDF, assign custom data‑type tags to header and cells, set l... |
...
<!-- AUTOGENERATED:START -->
Updated: 2026-04-09 | Run: `20260409_134415_73471e`
<!-- AUTOGENERATED:END -->
