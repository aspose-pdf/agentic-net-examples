...
<script type="application/ld+json">
{
  ...
  "name": "Pages -- Aspose.PDF for .NET Examples",
  "description": "100 verified, compile-tested C# examples demonstrating pages operations in Aspose.PDF for .NET 26.7.0.",
  ...
  "codeRepository": "https://github.com/aspose-pdf/agentic-net-examples.git/tree/main/pages",
...
- [`add-dynamic-year-watermark-to-pdf-pages.cs`](./add-dynamic-year-watermark-to-pdf-pages.cs) -- Add dynamic year watermark to pdf pages
...
- [`add-text-header-to-first-pdf-page.cs`](./add-text-header-to-first-pdf-page.cs) -- Add text header to first pdf page
...
- [`insert-blank-page-at-index.cs`](./insert-blank-page-at-index.cs) -- Insert blank page at index
- [`insert-blank-pages-double-pdf-page-count.cs`](./insert-blank-pages-double-pdf-page-count.cs) -- Insert blank pages double pdf page count
- [`insert-chapter-page-numbers-into-pdf.cs`](./insert-chapter-page-numbers-into-pdf.cs) -- Insert chapter page numbers into pdf
...
- [`insert-page-matching-size-from-page-2.cs`](./insert-page-matching-size-from-page-2.cs) -- Insert page matching size from page 2
...
- [`read-page-dimensions-from-pdf.cs`](./read-page-dimensions-from-pdf.cs) -- Read page dimensions from pdf
...
- [`reset-pdf-page-rotation.cs`](./reset-pdf-page-rotation.cs) -- Reset pdf page rotation
- [`resize-all-pdf-pages-to-a5.cs`](./resize-all-pdf-pages-to-a5.cs) -- Resize all pdf pages to a5
- [`resize-first-pdf-page-custom-dimensions.cs`](./resize-first-pdf-page-custom-dimensions.cs) -- Resize first pdf page custom dimensions
- [`resize-pdf-pages-to-fixed-width.cs`](./resize-pdf-pages-to-fixed-width.cs) -- Resize pdf pages to fixed width
...
- [`resize-seventh-pdf-page-to-letter-size.cs`](./resize-seventh-pdf-page-to-letter-size.cs) -- Resize seventh pdf page to letter size
...
- [`rotate-even-pages-pdf.cs`](./rotate-even-pages-pdf.cs) -- Rotate even pages pdf
...
- [`rotate-pdf-pages-by-configurable-angles.cs`](./rotate-pdf-pages-by-configurable-angles.cs) -- Rotate pdf pages by configurable angles
...
- [`trim-white-space-around-pdf-pages.cs`](./trim-white-space-around-pdf-pages.cs) -- Trim white space around pdf pages
