...
- `using Aspose.Pdf;` (100/133 files) ← category-specific
- `using Aspose.Pdf.Text;` (17/133 files)
- `using Aspose.Pdf.Facades;` (3/133 files)
- `using Aspose.Pdf.Annotations;` (2/133 files)
- `using Aspose.Pdf.Drawing;` (2/133 files)
- `using System;` (100/133 files)
- `using System.IO;` (98/133 files)
- `using System.Collections.Generic;` (5/133 files)
- `using System.Linq;` (4/133 files)
- `using System.Text.Json;` (1/133 files)
...
|------|-------|----------|-------------|
| [add-alphanumeric-bates-numbering-to-pdf](./add-alphanumeric-bates-numbering-to-pdf.cs) | Add alphanumeric bates numbering to pdf |  | Add alphanumeric bates numbering to pdf |
| [add-bates-numbering-increment-5](./add-bates-numbering-increment-5.cs) | Add bates numbering increment 5 |  | Add bates numbering increment 5 |
...
| [add-bates-numbering-to-pdf](./add-bates-numbering-to-pdf.cs) | Add bates numbering to pdf |  | Add bates numbering to pdf |
...
| [add-blank-front-matter-page-with-label-i](./add-blank-front-matter-page-with-label-i.cs) | Add blank front matter page with label i |  | Add blank front matter page with label i |
...
| [add-curved-text-watermark-to-pdf-page](./add-curved-text-watermark-to-pdf-page.cs) | Add curved text watermark to pdf page |  | Add curved text watermark to pdf page |
...
| [add-header-with-logo-to-pdf-pages](./add-header-with-logo-to-pdf-pages.cs) | Add header with logo to pdf pages |  | Add header with logo to pdf pages |
...
| [add-image-footer-30-opacity](./add-image-footer-30-opacity.cs) | Add image footer 30 opacity |  | Add image footer 30 opacity |
...
| [add-multiple-empty-pages-sequentially](./add-multiple-empty-pages-sequentially.cs) | Add multiple empty pages sequentially |  | Add multiple empty pages sequentially |
...
| [add-page-numbers-leading-zeros](./add-page-numbers-leading-zeros.cs) | Add page numbers leading zeros |  | Add page numbers leading zeros |
