...
- `using Aspose.Pdf;` (70/121 files) ← category-specific
- `using Aspose.Pdf.Text;` (17/121 files)
- `using Aspose.Pdf.Annotations;` (7/121 files)
- `using Aspose.Pdf.Devices;` (4/121 files)
- `using Aspose.Pdf.Forms;` (4/121 files)
- `using Aspose.Pdf.Optimization;` (4/121 files)
- `using Aspose.Pdf.Drawing;` (2/121 files)
- `using Aspose.Pdf.Comparison;` (1/121 files)
- `using Aspose.Pdf.Facades;` (1/121 files)
- `using Aspose.Pdf.LogicalStructure;` (1/121 files)
- `using Aspose.Pdf.Tagged;` (1/121 files)
- `using System;` (72/121 files)
- `using System.IO;` (70/121 files)
- `using System.Xml.Linq;` (15/121 files)
- `using System.Xml;` (10/121 files)
- `using System.Collections.Generic;` (4/121 files)
- `using System.Data;` (2/121 files)
- `using System.Linq;` (2/121 files)
- `using System.Text;` (2/121 files)
- `using Microsoft.Extensions.DependencyInjection;` (1/121 files)
- `using System.Diagnostics;` (1/121 files)
- `using System.Globalization;` (1/121 files)
- `using System.Text.Json;` (1/121 files)
- `using System.Threading;` (1/121 files)
...
|------|-------|----------|-------------|
| [add-automatic-page-numbers-to-pdf](./add-automatic-page-numbers-to-pdf.cs) | Add automatic page numbers to pdf |  | Add automatic page numbers to pdf |
...
| [add-header-footer-to-pdf-from-xml](./add-header-footer-to-pdf-from-xml.cs) | Add header footer to pdf from xml |  | Add header footer to pdf from xml |
...
| [apply-custom-background-color-to-pdf-pages](./apply-custom-background-color-to-pdf-pages.cs) | Apply custom background color to pdf pages |  | Apply custom background color to pdf pages |
| [apply-custom-colour-scheme-xml-xsl](./apply-custom-colour-scheme-xml-xsl.cs) | Apply custom colour scheme xml xsl |  | Apply custom colour scheme xml xsl |
...
| [apply-section-based-page-margins](./apply-section-based-page-margins.cs) | Apply section based page margins |  | Apply section based page margins |
...
| [compress-pdf-flate-after-xml-conversion](./compress-pdf-flate-after-xml-conversion.cs) | Compress pdf flate after xml conversion |  | Compress pdf flate after xml conversion |
...
| [convert-pdf-pages-to-high-resolution-png-thumbnail...](./convert-pdf-pages-to-high-resolution-png-thumbnails.cs) | Convert pdf pages to high resolution png thumbnails |  | Convert pdf pages to high resolution png thumbnails |
...
| [convert-xml-multiple-namespaces-to-pdf](./convert-xml-multiple-namespaces-to-pdf.cs) | Convert xml multiple namespaces to pdf |  | Convert xml multiple namespaces to pdf |
| [convert-xml-to-html-preview](./convert-xml-to-html-preview.cs) | Convert xml to html preview |  | Convert xml to html preview |
| [convert-xml-to-pdf-version-1-7](./convert-xml-to-pdf-version-1-7.cs) | Convert xml to pdf version 1 7 |  | Convert xml to pdf version 1 7 |
