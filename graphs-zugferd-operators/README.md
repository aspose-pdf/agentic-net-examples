...
- [`compress-pdf-and-optimize-images.cs`](./compress-pdf-and-optimize-images.cs) -- Compress pdf and optimize images
...
- [`embed-vector-graphic-in-pdf.cs`](./embed-vector-graphic-in-pdf.cs) -- Embed vector graphic in pdf
...
- [`modify-pdf-line-width-operators.cs`](./modify-pdf-line-width-operators.cs) -- Modify pdf line width operators
...
- [`set-pdf-title-author-invoice-number.cs`](./set-pdf-title-author-invoice-number.cs) -- Set pdf title author invoice number
