...
<script type="application/ld+json">
{
  ...
  "name": "Working with forms -- Aspose.PDF for .NET Examples",
  "description": "230 verified, compile-tested C# examples demonstrating working with forms operations in Aspose.PDF for .NET 26.7.0.",
  ...
  "codeRepository": "https://github.com/aspose-pdf/agentic-net-examples.git/tree/main/working-with-forms",
